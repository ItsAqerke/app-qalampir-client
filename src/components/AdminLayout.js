        ...
        <div className="admin-layout">
            <div className="admin-layout-left">
                <div className="user-info d-flex justify-content-between align-items-center">
                    <img src="/assets/images/user.svg" alt="vvvv"/>
                    <div>
                ...
                <div className="menus">
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item"><Link to="/admin/news/en" className={`nav-link ${history.location.pathname === "/admin/news/en" ? "active" : " "}`}><RiNewspaperLine/>Yangiliklar (ENG)</Link></li>
                    </ul>
                </div>
            </div>
